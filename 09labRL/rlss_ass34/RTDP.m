...
% function [Q] = RTDP(MDP)
%
% This function computes the optimal Q-function for the MDP M using 
% real-time DP. M is a structure with the following fields:
%
...
% Initialize the MDP. Since RTDP relies on transitions sampled from the 
% actual MDP, use this space for any initialization of the MDP.
...
h = waitbar(0, 'Running, please wait...', 'Name', 'RTDP');

t = cputime;

for iter = 1:NITER
    
    % Use this space to implement the RTDP updates. If you need to 
...
% variable Q, so do not forget to assign the result of your algorithm to
