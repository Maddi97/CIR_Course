...
% Q-learning. M is a structure with the following fields:
%
...
% Initialize the MDP. Since Q-learning relies on transitions sampled from 
...
h = waitbar(0, 'Running, please wait...', 'Name', 'Q-Learning');

t = cputime;

for iter = 1:NITER
    
    % Use this space to implement the Q-learning update. If you need to 
